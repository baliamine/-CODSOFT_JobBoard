...
const JobDetails = () => {
  ...
  const { user } = UseAuthContext(); // Get user from UseAuthContext
      ...
      <div className="job-details-container">
        ...
        <div className="job-details-section">
          ...
          <ol className="hiring-process-steps">
            ...
            <li>
              <strong>Phone Interview:</strong> If selected, you will be
              contacted for a brief phone interview to discuss your experience
              and skills.
            </li>
            <li>
            ...
            <li>
              ...
              formal offer, outlining the terms and conditions of the
              employment.
            </li>
          </ol>
          <p>
